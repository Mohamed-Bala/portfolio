                                        ...
                                        <tbody>
                                                ...
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-md">
                                                            <img src="{{ URL::to('admin/images/about.jpg') }}">
                                                        </div>
                                            ...
                                            <tr>
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-md">
                                                            <img src="{{ URL::to('admin/images/personal1.jpg') }}">
                                                        </div>
                    ...
                    <div class="card-body py-3 px-2">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-xl">
                                <img src="{{ URL::to('admin/images/personal1.jpg') }}" alt="">
                            </div>
                            <br>
                            
                        </div>
                        <div class="ms-3 name">
                            <h5 class="font-bold">mohammed</h5>
                        </div>
                    </div>
                </div>
                {{-- user profile modal --}}
                    ...
                    <div class="card-content pb-4">
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="avatar avatar-lg">
                                <img src="{{ URL::to('admin/images/testimonial-3.jpg') }}">
                            </div>
                            <div class="name ms-4">
                        ...
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="avatar avatar-lg">
                                <img src="{{ URL::to('admin/images/testimonial-1.jpg') }}">
                            </div>
                            <div class="name ms-4">
                        ...
                        <div class="recent-message d-flex px-4 py-3">
                            <div class="avatar avatar-lg">
                                <img src="{{ URL::to('admin/images/testimonial-2.jpg') }}">
                            </div>
                            <div class="name ms-4">
